...
6. **Icarus JavaScript Bindings**: Write game modifications in JavaScript/TypeScript with the embedded Node.js runtime. See [docs/NODEJS_INTEGRATION.md](docs/NODEJS_INTEGRATION.md) for details.
